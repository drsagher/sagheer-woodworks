...
export default function DelRecord(){
    ...
    return(
        <div className="flex flex-col gap-6 items-center w-full">
            <div className="flex text-red-600 font-bold uppercase"><IoMdWarning size={35}/>DELETE LEDGER RECORD</div>
            ...
            <div className="flex items-center gap-2 p-2 w-full justify-center border-2">
                ...
                <button className="text-red-700" onClick={() => delEntry(delEntryUrl)}><MdDeleteForever size={40}/>
                </button>
            </div>
            ...
            <div className="flex items-center gap-2 p-2 w-full justify-center border-2">
                ...
                <button className="text-red-800" onClick={() => delClient(delClientUrl)}><MdDeleteForever size={40}/>
                </button>
            </div>
            ...
            <div className="flex items-center gap-2 p-2 w-full justify-center border-2">
                ...
                <button className="text-red-700" onClick={() => delUser(delUserUrl)}><MdDeleteForever size={40}/>
                </button>
            </div>
